...
class RuleEngineController extends AbstractController
{
  ...
  public function test(AuthService $authService, CallApiService $callApiService, string $uploadDir, FileUploader $uploader, \Swift_Mailer $mailer, Request $request): Response
  {
