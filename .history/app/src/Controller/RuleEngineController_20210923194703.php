...
class RuleEngineController extends AbstractController
{
  ...
  public function test(AuthService $authService, CallApiService $callApiService, string $uploadDir, FileUploader $uploader, \Swift_Message $mailer, Request $request): Response
  {
