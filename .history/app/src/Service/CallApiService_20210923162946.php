...
class CallApiService
{
  ...
  public function upload_file($token, $filePath, $repositoryName, $commitName)
  {
    try {
      ...
      $response = $this->client->request('POST', 'https://app.debricked.com/api/1.0/open/uploads/dependencies/files', [
        'headers' => array_merge(['Authorization' => 'Bearer ' . $token],$formData->getPreparedHeaders()->toArray()),
